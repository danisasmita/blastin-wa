    ...
    translations: {
      ...
      contacts: {
        ...
        confirmationModal: {
          ...
          bulkDeleteSelectedTitle: "Delete selected contacts",
          bulkDeleteSelectedMessage:
            "You are about to delete {{count}} selected contacts. All related tickets will be lost.",
          bulkDeleteFilteredTitle: "Delete filtered contacts",
          bulkDeleteFilteredMessage:
            "You are about to delete {{count}} contacts matching the current search filter. All related tickets will be lost.",
        },
        buttons: {
      ...
      campaigns: {
        ...
        fields: {
          ...
          template: "Template",
          templateOptional: "No template",
          body: "Message body",
          bodyHelp: "Use {{name}} to personalize the message.",
        ...
        tooltips: {
          syncRecipients: "Refresh recipients",
          dispatch: "Start sending",
        ...
        toasts: {
          ...
          dispatchStarted: "Campaign dispatch started.",
          paused: "Campaign paused.",
          synced: "Campaign recipients refreshed.",
        },
        confirmationModal: {
          title: "Delete item",
      ...
      campaignTemplates: {
        ...
        fields: {
          name: "Name",
          body: "Template body",
          bodyHelp: "Supports placeholders like {{name}}.",
          isActive: "Active",
        },
        table: {
          name: "Name",

    ...
    translations: {
      ...
      contacts: {
        ...
        toasts: {
          ...
          bulkDeleted: "{{count}} contatos excluidos com sucesso!",
        },
        ...
        confirmationModal: {
          ...
          bulkDeleteSelectedTitle: "Excluir contatos selecionados",
          bulkDeleteSelectedMessage:
            "Voce esta prestes a excluir {{count}} contatos selecionados. Todos os tickets relacionados serao perdidos.",
          bulkDeleteFilteredTitle: "Excluir contatos filtrados",
          bulkDeleteFilteredMessage:
            "Voce esta prestes a excluir {{count}} contatos que correspondem ao filtro atual. Todos os tickets relacionados serao perdidos.",
        },
        buttons: {
          import: "Importar Contatos",
          add: "Adicionar Contato",
          deleteSelected: "Excluir Selecionados",
          deleteFiltered: "Excluir Filtrados",
        },
        table: {
          name: "Nome",
          whatsapp: "WhatsApp",
      ...
      campaigns: {
        ...
        fields: {
          ...
          template: "Template",
          templateOptional: "Sem template",
          body: "Mensagem",
          bodyHelp: "Use {{name}} para personalizar a mensagem.",
        ...
        tooltips: {
          syncRecipients: "Atualizar destinatários",
          dispatch: "Iniciar envio",
          pause: "Pausar campanha",
        },
        modal: {
          addTitle: "Nova Campanha",
          editTitle: "Editar Campanha",
        },
        toasts: {
          deleted: "Item removido com sucesso.",
          dispatchStarted: "Envio da campanha iniciado.",
          paused: "Campanha pausada.",
          synced: "Destinatários da campanha atualizados.",
        },
        confirmationModal: {
          title: "Excluir item",
      ...
      campaignTemplates: {
        ...
        fields: {
          ...
          bodyHelp: "Aceita placeholders como {{name}}.",
          isActive: "Ativo",
        },
        table: {
          name: "Nome",

    ...
    translations: {
      ...
      campaigns: {
        ...
        fields: {
          ...
          template: "Template",
          templateOptional: "Sin template",
          body: "Mensaje",
          bodyHelp: "Usa {{name}} para personalizar el mensaje.",
          scheduledAt: "Programación",
          sendDelayMs: "Intervalo entre envíos (ms)",
        ...
        tooltips: {
          syncRecipients: "Actualizar destinatarios",
          dispatch: "Iniciar envío",
        ...
        toasts: {
          ...
          dispatchStarted: "Envío de campaña iniciado.",
          paused: "Campaña pausada.",
          synced: "Destinatarios de la campaña actualizados.",
        },
        confirmationModal: {
      ...
      campaignTemplates: {
        ...
        fields: {
          ...
          bodyHelp: "Admite placeholders como {{name}}.",
          isActive: "Activo",
        },
        table: {
          name: "Nombre",
